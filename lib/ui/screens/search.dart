      ...
      body: Container(
        ...
        children: [
         ...
         child: Column(
          children: [
          Text(
          'Escolha a cidade que você gostaria',
          style: TextStyle(fontSize: 18, color: Colors.white.withOpacity(0.5))
          ),
          Text(
          'de saber os detalhes do tempo',
          style: TextStyle(fontSize: 18, color: Colors.white.withOpacity(0.5))
          ),
        ],
         )
         ...
         Padding(padding: EdgeInsets.symmetric(horizontal: myWidth * 0.06),
         child: Row(
          children: [
           Expanded(
           flex: 5,
                      ...
                      children: [
                       Row(
                        ...
                        Column(
                         ...
                         children: [
                          Text(widget.weatherModel[index].weeklyWeather![index]!.mainTemp
                          .toString()
                          .replaceAll('C', ''),
                          style: TextStyle(
                           fontSize: 30,
                          ...
                          Text(weather_state[index].toString(),
                          style: TextStyle(fontSize: 14, color: Colors.white.withOpacity(0.5)),
                          ),
                         ],
                        ),
                        Image.asset(widget.weatherModel[index].weeklyWeather![index]!.mainImg
                        .toString(),
                       ...
                       Row(
                       children: [
                       Text(widget.weatherModel[index].name.toString(),
